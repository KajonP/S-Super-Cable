...
--
-- Host: localhost:3306
-- Generation Time: Nov 15, 2021 at 04:49 PM
...
(20211031140213, 'test', '', '', '', '2021-11-14 15:09:16', 'a001'),
(20211031140920, 'test2', '', '', '', '2021-11-14 15:09:44', ' ');
...
(7, 20211031140213, '4322cd3ae6b41ab7f374c5a9793cd489.jpg');
...
(1, 'a001', 20211031140920, 0),
(2, 'a004', 20211031140920, 0),
(3, 's0001', 20211031140920, 0),
(4, 's009', 20211031140920, 0),
(5, 'x007', 20211031140920, 0),
(6, 'x0079', 20211031140920, 0);
...
(2, 'format_excel_company.png', 'manage_company', '2021-11-15 16:42:38'),
...
(20211027230902, 'test', '<p>yes or no&nbsp;</p>\r\n', '', '', '', '2021-11-14 15:14:28'),
(20211114150748, 'lrrd', '<p>tree</p>\r\n', '', '', '', '2021-11-14 15:07:48'),
(20211114150800, 'wrdse', '<p>eed</p>\r\n', '', '', '', '2021-11-14 15:08:00');
...
(14, 20211027230902, '84391235570901cf0449ab2fdbc9e508.jpg'),
(15, 20211027230902, '8810a057c4cdaa1a2e803b0bdd294b4b.jpg'),
(17, 20211027230902, '3a3fe3dfe460b826d0733115594327a5.jpg'),
(18, 20211027230902, '5b0a1452ecfcb551a2d11edb74aa844f.jpg'),
(19, 20211114150748, '073447a2e41df3e447b7a28386ee0071.jpg');
...
(1, 's0001', 20211027230902, 0),
(2, 's0001', 20211114150748, 0),
(3, 's009', 20211027230902, 0);
...
(5, '2021-02-03', 1, 'a001', 30),
(6, '2020-06-15', 1, 'a001', 300),
(7, '2020-10-01', 33336, 's0001', 300),
(8, '2019-08-15', 1, 'a001', 3000),
(9, '2019-08-15', 33336, 'a004', 5200);
...
--
ALTER TABLE `award_status`
  MODIFY `ID_Award_Status` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `message`
  MODIFY `ID_Message` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20211114150801;
...
--
ALTER TABLE `message_status`
  MODIFY `ID_Message_Status` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `sales`
  MODIFY `ID_Excel` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
