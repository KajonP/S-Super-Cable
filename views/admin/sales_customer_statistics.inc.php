    ...
    <div class=" content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-md-12">
                        <h1 class="m-0">หน้ารายงานเปรียบเทียบยอดขายโดยเลือกจากบริษัทลูกค้า </h1>
                        <div class="card">
                            <div class="card-body">
...
<script type="text/javascript" src="AdminLTE/assets/js/page/sales_customer_statistics.js"></script>
<style>
.tb_center td{
    text-align: center;
}
