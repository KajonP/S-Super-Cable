...
try {
                                ...
                                <div class="col-md-12 text-right">
                                    ...
                                    <a href="#" onclick="goodsmanageShow('create')"
                                       class="collapse-link text-right mt-2 mb-2 mr-2" style="color: #415468;">
                                        <span class="btn btn-round btn-success"
                                              style=" font-size: 13px; padding: 0 15px; margin-bottom: inherit;"><i
                                                class="fa fa-plus"></i> สร้างสินค้า </span>
                                    </a>
                                </div>
                            </div>
                            <div class="card-body p-0 d-flex">
                                <div class="table-responsive">
                                    <table id="tbl_goodsmanagement" class="table table-md" style="width:100%;">
                                        <thead>
                                        <tr>
                                            <th>เลขที่</th>
                                            <th>ชื่อสินค้า</th>
    ...
    include Router::getSourcePath() . "views/modal/modal_goodsmanage.inc.php";
...
<script type="text/javascript" src="AdminLTE/assets/js/page/manage_goods.js"></script>
