            ...
            <div class="row mb-2">
                ...
                <div class="form-group row mt-2 mb-2 mr-1">
                    <div class="col-md-12 text-right">
                         <a href="index.php?controller=Admin&action=export_excel"   class="collapse-link text-right mt-2 mb-2 mr-2" style="color: #415468;">
                            <span class="btn btn-round btn-success" style=" font-size: 13px; padding: 0 15px; margin-bottom: inherit;"><i class="fa fa-file"></i> ดาวน์โหลดไฟล์ excel </span>
                        </a>
                        ...
                        <a href="#"  onclick="usermanageShow('create')" class="collapse-link text-right mt-2 mb-2 mr-2" style="color: #415468;">
                            <span class="btn btn-round btn-success" style=" font-size: 13px; padding: 0 15px; margin-bottom: inherit;"><i class="fa fa-plus"></i> สร้างผู้ใช้งาน </span>
                        </a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" last">
                                                <a href="#"  onclick="usermanageShow('edit','<?php echo $value->getID_Employee();?>')">
                                                    <button type="button" class="btn btn-round btn-warning text-center" style=" font-size: 13px; padding: 0 15px; margin-bottom: inherit;width:96px !important;"><i class="fa fa-wrench"></i> เเก้ไข</button>
                                                </a>
