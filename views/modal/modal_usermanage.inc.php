        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form_usermanage" method='post' action='' enctype="multipart/form-data">
                    ...
                    <a href="#" id="resetpassword" class="btn btn-primary btn-block"><i class="fa fa-key"></i> Reset
                        Password</a>

                    <div class="form-group" id="div_password" style="display:none;">
                        <label for="Password_Employee" id="lbl_Password_Employee"
                        ...
                        <label for="Password_Employee" id="lbl_Password_Employee" class="col-form-label">Confirm
                            Password:</label>
