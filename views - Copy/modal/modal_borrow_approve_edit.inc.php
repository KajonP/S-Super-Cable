<div class="modal fade" id="formDataModal2" tabindex="-1" role="dialog" aria-labelledby="borrowmanageModalDialog"aria-hidden="true">
    <div class="modal-dialog" role="document">
    <!-- Form -->
        <form id="form_modal2" method='post' action='' enctype="multipart/form-data" onsubmit="edit(); return false;">
