...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 09, 2021 at 04:15 PM
...
(1, 2, 5, '2021-07-07', '', 'a001', 1, 1),
(2, 2, 5, '2021-07-07', '', 'a001', 2, 1),
(3, 2, 300, '2021-07-13', '', 'a001', 1, 1),
(5, 2, 5, '2021-07-16', '', 'a001', 1, 2),
(6, 2, 50000, '2021-07-29', '', 'a001', 1, 2),
(7, 2, 5000, '2021-07-30', '', 'a001', 1, 2),
(8, 2, 1, '2021-08-12', 'ee', 'a001', 1, 1),
(9, 2, 4, '2021-08-12', 'r', 'a001', 1, 0),
(10, 2, 2, '2021-08-12', '1', 'a001', 1, 0),
(11, 2, 123, '2021-08-12', '7899', 'a001', 1, 0),
(12, 2, 5, '2021-08-23', '', 'a001', 2, 0),
(13, 2, 1, '2021-08-25', '', 'a001', 2, 0);
...
(1, '111', '111', 1, NULL, '1111111111', '1111111111@1111.com', '1111111111111', 50000, '3เดือน', 1, '-', 'ไม่ใช่', '-', 'a001'),
(33335, '111', '222', 1, NULL, '1111111111', '1111111111@1111.com', '1111111111111', 50000, '3เดือน', 1, NULL, 'ไม่ใช่', NULL, NULL);
...
(2, 'ผป', '2020-01-12', '1', 'ปแ', '44', '22', 0, '', 'rr', 'rr', '33', 'novat', 7, 0, 0, 0, 0, 1, 1),
(5, '9899', '2020-01-12', '3เดือน', '111', '-', '222', 0, '0', '1111111111@1111.com', '1111111111', '1111111111111', 'novat', 7, 5670, 0, 81000, 86670, 33335, 1),
(6, '9899', '2020-01-12', '3เดือน', '111', '-', '222', 0, '0', '1111111111@1111.com', '1111111111', '1111111111111', 'novat', 7, 0, 0, 10000, 10700, 33335, 1),
(7, '900', '2020-01-12', '3เดือน', '111', '-', '111', 0, '0', '1111111111@1111.com', '9999', '1111111111111', 'novat', 7, 70, 0, 1000, 1070, 1, 1),
(8, '9899', '2021-09-16', '3เดือน', '111', '-', '111', 0, '0', '1111111111@1111.com', '1111111111', '1111111111111', 'exclude', 7, 420, 0, 6000, 6420, 1, 1);
...
(8, 'สายไฟ', 1, 1000, 1000, 1, 7),
(9, 'สายไฟ', 1, 1000, 1000, 1, 5),
(10, 'สายไฟ2', 80, 1000, 80000, 5, 5),
(11, 'สายไฟ', 6, 1000, 6000, 1, 8);
...
--
ALTER TABLE `award`
  MODIFY `ID_Award` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20210711184850;

--
-- AUTO_INCREMENT for table `borroworreturn`
--
ALTER TABLE `borroworreturn`
  MODIFY `ID_BorrowOrReturn` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `company`
  MODIFY `ID_Company` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33336;
...
--
ALTER TABLE `invoice`
  MODIFY `ID_Invoice` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `invoice_detail`
--
ALTER TABLE `invoice_detail`
  MODIFY `ID_Invoice_Detail` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `message`
--
ALTER TABLE `message`
  MODIFY `ID_Message` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20210909203629;
...
--
ALTER TABLE `sales`
  MODIFY `ID_Excel` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `zone`
  MODIFY `ID_Zone` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
