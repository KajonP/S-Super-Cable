...
--
-- Host: 127.0.0.1
-- Generation Time: May 26, 2021 at 09:09 AM
...
CREATE TABLE `award` (
  ...
  `Picture_Award` text DEFAULT NULL,
  `Date_Award` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
