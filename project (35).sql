...
INSERT INTO `award` (`ID_Award`, `Tittle_Award`, `Picture_Award`, `Date_Award`, `ID_Employee`) VALUES
(20210612112012, 'test2', './images/28b06e384aef7d89b51f063bdfe47f16.png', '2021-06-12 11:20:12', 's0001'),
(20210612112023, 'test', './images/7ae6e32b05282e5f6e285b09136186f2.jpg', '2021-06-12 11:20:23', 's009'),
(20210612120021, '555', './images/605c8cb05763b37e93681dc06265569e.jpg', '2021-06-12 12:00:21', 'x007'),
(20210615081534, '555', './images/3b4242c44b9221d493d1be71dcc09825.jpg', '2021-06-15 08:15:34', 'x007');
...
('s009', 20210528034617, 1),
('a001', 20210612091357, 0),
('a004', 20210612091357, 0),
('s0001', 20210612091357, 1),
('s009', 20210612091357, 1),
('x007', 20210612091357, 0),
('x0079', 20210612091357, 0),
('a001', 20210612112012, 0),
('a004', 20210612112012, 0),
('s0001', 20210612112012, 1),
('s009', 20210612112012, 1),
('x007', 20210612112012, 0),
('x0079', 20210612112012, 0),
('a001', 20210612112023, 0),
('a004', 20210612112023, 0),
('s0001', 20210612112023, 1),
('s009', 20210612112023, 0),
('x007', 20210612112023, 0),
('x0079', 20210612112023, 0),
('a001', 20210612120021, 0),
('a004', 20210612120021, 0),
('s0001', 20210612120021, 1),
('s009', 20210612120021, 1),
('x007', 20210612120021, 0),
('x0079', 20210612120021, 0),
('a001', 20210615081534, 0),
('a004', 20210615081534, 0),
('s0001', 20210615081534, 1),
('s009', 20210615081534, 0),
('x007', 20210615081534, 0),
('x0079', 20210615081534, 0);
...
CREATE TABLE `borroworreturn` (
  ...
  `Detail_BorrowOrReturn` text DEFAULT NULL,
  `ID_Employee` varchar(255) NOT NULL,
...
INSERT INTO `company` (`ID_Company`, `Name_Company`, `Address_Company`, `PROVINCE_ID`, `AMPHUR_ID`, `Tel_Company`, `Email_Company`, `Tax_Number_Company`, `Credit_Limit_Company`, `Credit_Term_Company`, `Cluster_Shop`, `Contact_Name_Company`, `IS_Blacklist`, `Cause_Blacklist`) VALUES
(2, '0002', '0002', 1, 16, '0999999991', '0002@hotmail.com', '0123456789123', 50000, '3 เดือน', 'ภาครัฐ', '-', 'ใช่', '-'),
(3, '0003', '0003', 1, 21, '0003111111', 'Natthawat.suetrong@gmail.com', '1111111111111', 200000, '3 เดือน', 'รัฐวิสาหกิจ', '-', 'ไม่ใช่', '-'),
(110, 'FIRSTSTEP', '300/15 montisuriyawong', 1, 2, '1234567890', 'firststep11@gmail.com', '1234567891233', 15000, '30 วัน', 'รัฐวิสาหกิจ', 'คุณณัฐวัฒน์', 'ใช่', 'ค้างจ่ายอยู่ 2 อินวอยน์'),
(111, '3333', '3333', 1, NULL, '3333', '3333', '3333', 3333, '3333', 'ภาครัฐ', '3333', 'ไม่ใช่', '3333'),
(113, 'ttttt', 'ttt', 17, 203, '4444444444', '444444@hotmail.com', 'dwadwadwadwad', 300000, '33333333333', 'ภาครัฐ', '33333', 'ใช่', '3333');
...
(11, 'dddsa', './uploads/5920504102_สำเนาหน้าบัญชี.pdf', 'ddddssret', '2021-06-29 01:52:32'),
(12, 'test', './uploads/5920504102_สำเนาหน้าบัญชี.pdf', 'ddd', '2021-06-24 21:25:49'),
(13, 'ttt', './uploads/5920504102_สำเนาบัตรนิสิต.pdf', 'testlol', '2021-07-06 02:57:25'),
(14, 'dddddd', './uploads/07-request-56.pdf', 'dd', '2021-07-03 04:21:58');
...
CREATE TABLE `goods` (
  ...
  `Detail_Goods` text DEFAULT NULL,
...
CREATE TABLE `invoice` (
  ...
  `Credit_Term_Company` varchar(255) NOT NULL,
  `Name_Company` varchar(255) NOT NULL,
  `Contact_Name_Company` text NOT NULL,
  `Address_Company` text NOT NULL,
  `Email_Company` text NOT NULL,
  `Tel_Company` int(10) NOT NULL,
  `Tax_Number_Company` varchar(13) NOT NULL,
  `Vat_Type` int(10) NOT NULL COMMENT '1=exclude, 2=include, 3=novat',
...
CREATE TABLE `message` (
  ...
  `Picture_Message` text DEFAULT NULL,
  `Picture_Message2` text DEFAULT NULL,
  `Picture_Message3` text DEFAULT NULL,
...
(20210701063500, 'test', '<p>สวัสดีทุกๆท่าน</p>\r\n', './images/0034e5ac5c62934700183fb1e66e33ca.png', './images/baa915ded84d1ac2de95d46d24c07f89.jpg', '', '2021-07-01 07:11:27'),
(20210701065701, 'ttt', '<p>dd</p>\r\n', '', '', '', '2021-07-01 06:57:01'),
(20210701071606, 'todo', '<p>ทำงาน</p>\r\n', './images/c3b512120e358192e217fd565c4eaefb.jpg', '', '', '2021-07-03 11:09:26'),
(20210703104118, 'good', '<p>ชมเชย</p>\r\n', '', '', '', '2021-07-03 10:41:18');
...
('s0001', 20210528034125, 1),
('a001', 20210612121902, 0),
('a004', 20210612121902, 0),
('s0001', 20210612121902, 1),
('s009', 20210612121902, 1),
('x007', 20210612121902, 0),
('x0079', 20210612121902, 0),
('a001', 20210612122334, 0),
('a004', 20210612122334, 0),
('s0001', 20210612122334, 1),
('s009', 20210612122334, 1),
('x007', 20210612122334, 0),
('x0079', 20210612122334, 0),
('a001', 20210612122608, 0),
('a004', 20210612122608, 0),
('s0001', 20210612122608, 1),
('s009', 20210612122608, 1),
('x007', 20210612122608, 0),
('x0079', 20210612122608, 0),
('a001', 20210615081522, 0),
('a004', 20210615081522, 0),
('s0001', 20210615081522, 0),
('s009', 20210615081522, 0),
('x007', 20210615081522, 0),
('x0079', 20210615081522, 0),
('a001', 20210701063500, 0),
('a004', 20210701063500, 0),
('s0001', 20210701063500, 0),
('s009', 20210701063500, 0),
('x007', 20210701063500, 0),
('x0079', 20210701063500, 0),
('a001', 20210701065701, 0),
('a004', 20210701065701, 0),
('s0001', 20210701065701, 0),
('s009', 20210701065701, 0),
('x007', 20210701065701, 0),
('x0079', 20210701065701, 0),
('a001', 20210701071606, 0),
('a004', 20210701071606, 0),
('s0001', 20210701071606, 0),
('s009', 20210701071606, 0),
('x007', 20210701071606, 0),
('x0079', 20210701071606, 0),
('a001', 20210703104118, 0),
('a004', 20210703104118, 0),
('s0001', 20210703104118, 0),
('s009', 20210703104118, 0),
('x007', 20210703104118, 0),
('x0079', 20210703104118, 0);
...
(41, '2021-05-01', 2, 's009', 5000),
(42, '2021-05-13', 2, 's009', 5000),
(43, '2021-05-14', 2, 's009', 5000),
(44, '2021-05-12', 2, 's009', 6000),
(46, '2021-06-24', 110, 'x0079', 10000),
(47, '2021-05-12', 2, 's009', 5000),
(48, '2021-05-12', 2, 's009', 5000),
(50, '2021-05-19', 2, 's009', 5000);
...
INSERT INTO `setting_vat` (`ID_Setting_Vat`, `Percent_Vat`) VALUES
(1, 7);
...
--
ALTER TABLE `award`
  MODIFY `ID_Award` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20210615081535;

--
-- AUTO_INCREMENT for table `borroworreturn`
--
ALTER TABLE `borroworreturn`
  MODIFY `ID_BorrowOrReturn` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `company`
--
ALTER TABLE `company`
  MODIFY `ID_Company` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;

--
-- AUTO_INCREMENT for table `file`
--
ALTER TABLE `file`
  MODIFY `ID_File` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `message`
  MODIFY `ID_Message` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20210703104119;
...
ALTER TABLE `award`
  ...
  ADD CONSTRAINT `award_ibfk_2` FOREIGN KEY (`ID_Award`) REFERENCES `award_status` (`ID_Award`);
...
--
ALTER TABLE `message`
  ADD CONSTRAINT `message_ibfk_1` FOREIGN KEY (`ID_Message`) REFERENCES `message_status` (`ID_Message`);
