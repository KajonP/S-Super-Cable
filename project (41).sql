...
--
-- Host: localhost:3306
-- Generation Time: Jul 17, 2021 at 03:14 PM
...
(20210711184849, 'test', './images/c2ee9c87bc182da316d221ed9b4b6413.png', './images/a0c834d745d0553a7b38c96d784f97b9.jpg', '', '2021-07-11 19:51:31', 'a004');
...
(33334, 'FIRSTSTEP', '300/15 montisuriyawong', 1, ' ', '1234567890', 'test_@hotmail.com', '1234567891234', 50000, '30 วัน', 'ภาคเอกชน', ' ', 'ใช่', ' ');
...
(22, 'testก', './uploads/1. การเมืองภาคประชาชน.pdf', '4444ก', '2021-07-16 07:06:59');
...
(20210711175735, '555', '<p>ttt</p>\r\n', './images/d0aab6545a5e39c9899a4a7097b17dea.jpg', '', '', '2021-07-15 19:32:58');
...
--
ALTER TABLE `borroworreturn`
  MODIFY `ID_BorrowOrReturn` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `message`
  MODIFY `ID_Message` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20210711175736;
